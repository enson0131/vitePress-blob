...
<span class="line"><span style="color:#24292E;">    }),</span></span>
<span class="line"><span style="color:#24292E;">  ],</span></span>
<span class="line"><span style="color:#24292E;">};</span></span></code></pre></div><p>host 和 remote 的区别在于： host 通过 remotes 引入模块 remote 通过 exposes 导出模块</p><p>如果是存在 shared 共享代码块得通过 bootstrap 动态引入 - <a href="https://webpack.js.org/concepts/module-federation/" target="_blank" rel="noreferrer">https://webpack.js.org/concepts/module-federation/</a></p><h2 id="项目应用图" tabindex="-1">项目应用图 <a class="header-anchor" href="#项目应用图" aria-label="Permalink to &quot;项目应用图&quot;">​</a></h2><p><img src="`+e+'" alt="项目应用图"></p><h2 id="案例代码" tabindex="-1">案例代码 <a class="header-anchor" href="#案例代码" aria-label="Permalink to &quot;案例代码&quot;">​</a></h2><p><a href="https://github.com/enson0131/learn/tree/main/%E6%A8%A1%E5%9D%97%E8%81%94%E9%82%A6" target="_blank" rel="noreferrer">案例代码</a></p><h2 id="原理" tabindex="-1">原理 <a class="header-anchor" href="#原理" aria-label="Permalink to &quot;原理&quot;">​</a></h2><p><img src="'+t+'" alt="项目应用图"></p><p>remote 远程模块暴露应用 host 加载远程模块后引用容器应用</p><p>若存在共享依赖会存储到同一个变量中（require.S）, 这个变量（require.S） 存放各个作用域下的共享模块， 可以通过 作用域名（scopeName）、包名（key）、版本 (version) 再去获取对应的共享模块合如 modules 中</p><p><a href="https://github.com/enson0131/learn/blob/main/%E6%A8%A1%E5%9D%97%E8%81%94%E9%82%A6/remote/serve/remoteEntry.js" target="_blank" rel="noreferrer">案例代码</a></p>',15),i=[r,E,y];function u(F,d,q,h,m,b){return l(),p("div",null,i)}const g=a(c,[["render",u]]);export{B as __pageData,g as default};
