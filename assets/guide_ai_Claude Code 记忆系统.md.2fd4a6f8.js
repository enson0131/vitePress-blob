...
<span class="line"><span style="color:#24292e;">不要写重复的代码。</span></span></code></pre></div><p>这些话虽然没有错，但其实 Claude 模型本身就知道这些。应该明确告诉 Claude ，你希望它具体做什么。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;"># 项目规范</span></span>
...
<span class="line"><span style="color:#24292e;">- 部署流程: 见 \`docs/deployment.md\`</span></span></code></pre></div><p>这样做有两个好处：</p><ol><li>CLAUDE.md 保持精简</li><li>当 Claude 需要进一步的细节信息时，可以按需读取引用文件</li><li></li></ol><h2 id="小结" tabindex="-1">小结 <a class="header-anchor" href="#小结" aria-label="Permalink to &quot;小结&quot;">​</a></h2><p>CLAUDE.md 的本质是<strong>将隐性的项目知识显性化</strong>。你越早为项目建立这份手册，Claude Code 就越能像一位真正熟悉项目的团队成员一样工作并决策，而不是每次都需要你从头介绍。</p>`,69),t=[c];function r(i,d,y,h,u,E){return n(),a("div",null,t)}const m=s(o,[["render",r]]);export{C as __pageData,m as default};
