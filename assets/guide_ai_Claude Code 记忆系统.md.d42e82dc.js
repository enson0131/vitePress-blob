...
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;">示例参考: \`src/routes/orders.ts\`</span></span></code></pre></div><p>明确路径、步骤清晰，让 Claude 才会稳定复用同一套工作流，而不是每次自由发挥。</p><h3 id="_4-渐进式披露-不要把一切都塞进-claude-md" tabindex="-1">4：渐进式披露：不要把一切都塞进 CLAUDE.md <a class="header-anchor" href="#_4-渐进式披露-不要把一切都塞进-claude-md" aria-label="Permalink to &quot;4：渐进式披露：不要把一切都塞进 CLAUDE.md&quot;">​</a></h3><p><strong>CLAUDE.md 定义默认决策，而不是承载全部知识</strong></p><p>对于非核心、但可能被用到的内容，正确的做法是引用，例如使用 @import 指令引用其他文件。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;"># 项目规范</span></span>
<span class="line"><span style="color:#e1e4e8;"></span></span>
...
<span class="line"><span style="color:#e1e4e8;">- 数据库设计: @import \`docs/database.md\`</span></span>
<span class="line"><span style="color:#e1e4e8;">- API 规范: @import \`docs/api-spec.md\`</span></span>
<span class="line"><span style="color:#e1e4e8;">- 部署流程: @import \`docs/deployment.md\`</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;"># 项目规范</span></span>
<span class="line"><span style="color:#24292e;"></span></span>
...
<span class="line"><span style="color:#24292e;">- 数据库设计: @import \`docs/database.md\`</span></span>
<span class="line"><span style="color:#24292e;">- API 规范: @import \`docs/api-spec.md\`</span></span>
<span class="line"><span style="color:#24292e;">- 部署流程: @import \`docs/deployment.md\`</span></span></code></pre></div><p>这样做有两个好处：</p><ol><li>CLAUDE.md 保持精简</li><li>当 Claude 需要进一步的细节信息时，可以按需读取引用文件</li></ol><h2 id="小结" tabindex="-1">小结 <a class="header-anchor" href="#小结" aria-label="Permalink to &quot;小结&quot;">​</a></h2><p>CLAUDE.md 的本质是<strong>将隐性的项目知识显性化</strong>。你越早为项目建立这份手册，Claude Code 就越能像一位真正熟悉项目的团队成员一样工作并决策，而不是每次都需要你从头介绍。</p>`,69),t=[c];function r(i,d,y,h,u,E){return n(),a("div",null,t)}const m=s(o,[["render",r]]);export{C as __pageData,m as default};
