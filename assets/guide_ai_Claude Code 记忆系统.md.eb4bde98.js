...
<span class="line"><span style="color:#24292E;">    });</span></span>
<span class="line"><span style="color:#24292E;">  });</span></span>
<span class="line"><span style="color:#24292E;">});</span></span></code></pre></div><h2 id="覆盖率要求" tabindex="-1">覆盖率要求 <a class="header-anchor" href="#覆盖率要求" aria-label="Permalink to &quot;覆盖率要求&quot;">​</a></h2><ul><li>业务逻辑: &gt; 80%</li><li>工具函数: &gt; 90%</li><li>路由/控制器: 可以较低</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">\`paths\` 字段让这个规则**只在编辑测试文件时生效**，不会浪费其他场景的上下文空间。</span></span>
<span class="line"><span style="color:#e1e4e8;"></span></span>
<span class="line"><span style="color:#e1e4e8;">### 个人本地级</span></span>
<span class="line"><span style="color:#e1e4e8;"></span></span>
<span class="line"><span style="color:#e1e4e8;">- **存放位置**：\`./CLAUDE.local.md\`</span></span>
<span class="line"><span style="color:#e1e4e8;">- **使用场景**：个人本地环境配置，不提交到版本库（加入 \`.gitignore\`）</span></span>
<span class="line"><span style="color:#e1e4e8;"></span></span>
<span class="line"><span style="color:#e1e4e8;">这一层适合存放只与你本地环境相关的内容，例如本地服务地址、调试用的数据库配置等：</span></span>
<span class="line"><span style="color:#e1e4e8;"></span></span>
<span class="line"><span style="color:#e1e4e8;">\`\`\`markdown</span></span>
<span class="line"><span style="color:#e1e4e8;"># 本地开发笔记</span></span>
<span class="line"><span style="color:#e1e4e8;"></span></span>
<span class="line"><span style="color:#e1e4e8;">## 我的环境</span></span>
<span class="line"><span style="color:#e1e4e8;">- 本地 API: http://localhost:3000</span></span>
<span class="line"><span style="color:#e1e4e8;">- 测试数据库: order_service_dev</span></span>
<span class="line"><span style="color:#e1e4e8;">- Redis: localhost:6379</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">\`paths\` 字段让这个规则**只在编辑测试文件时生效**，不会浪费其他场景的上下文空间。</span></span>
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;">### 个人本地级</span></span>
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;">- **存放位置**：\`./CLAUDE.local.md\`</span></span>
<span class="line"><span style="color:#24292e;">- **使用场景**：个人本地环境配置，不提交到版本库（加入 \`.gitignore\`）</span></span>
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;">这一层适合存放只与你本地环境相关的内容，例如本地服务地址、调试用的数据库配置等：</span></span>
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;">\`\`\`markdown</span></span>
<span class="line"><span style="color:#24292e;"># 本地开发笔记</span></span>
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;">## 我的环境</span></span>
<span class="line"><span style="color:#24292e;">- 本地 API: http://localhost:3000</span></span>
<span class="line"><span style="color:#24292e;">- 测试数据库: order_service_dev</span></span>
<span class="line"><span style="color:#24292e;">- Redis: localhost:6379</span></span></code></pre></div><h2 id="小结" tabindex="-1">小结 <a class="header-anchor" href="#小结" aria-label="Permalink to &quot;小结&quot;">​</a></h2><table><thead><tr><th>层级</th><th>路径</th><th>作用域</th><th>是否提交 Git</th></tr></thead><tbody><tr><td>企业策略</td><td><code>/etc/claude-code/CLAUDE.md</code></td><td>全公司</td><td>—</td></tr><tr><td>用户级</td><td><code>~/.claude/CLAUDE.md</code></td><td>个人全局</td><td>—</td></tr><tr><td>项目级</td><td><code>./CLAUDE.md</code></td><td>整个项目</td><td>✅</td></tr><tr><td>项目规则</td><td><code>.claude/rules/*.md</code></td><td>条件加载</td><td>✅</td></tr><tr><td>本地级</td><td><code>./CLAUDE.local.md</code></td><td>个人本地</td><td>❌</td></tr></tbody></table><p>CLAUDE.md 的本质是<strong>将隐性的项目知识显性化</strong>。你越早为项目建立这份手册，Claude Code 就越能像一位真正熟悉项目的团队成员一样工作，而不是每次都需要你从头介绍。</p>`,40),t=[c];function r(i,d,y,E,u,h){return n(),a("div",null,t)}const F=s(o,[["render",r]]);export{g as __pageData,F as default};
