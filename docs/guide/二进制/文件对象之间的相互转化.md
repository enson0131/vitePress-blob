...
![ArrayBuffer](./../../public/assets/二进制/1.png)
...
![ArrayBuffer](./../../public/assets/二进制/2.png)
...
![DataView](./../../public/assets/二进制/3.png)
...
![Blob-ArrayBuffer](./../../public/assets/二进制/4.png)
...
[字符编码](https://enson0131.github.io/vitePress-blob/guide/%E4%BA%8C%E8%BF%9B%E5%88%B6/%E7%BC%96%E7%A0%81%E5%AD%97%E7%AC%A6%E9%9B%86)
...
<body>
    ...
    <script>
        ...
        uploadImage.addEventListener("change", (e) => {
            ...
            reader.onload = (e) => {
                img.src = e.target.result; // 图片的base64字符串
            };
...
```js
const text = 'Hello world!'; // 12 个字符长度
const base64 = btoa(text); 
console.log(base64); // SGVsbG8gd29ybGQ= 16 个字符长度
const blob = new Blob([atob(base64)], { type: 'text/plain' });
console.log(blob);
```


为什么 base64 比 原来的字符串更大？

- 原字符串（如 ASCII 字符）每个字符占 8 个二进制位（1 字节）。
